...
function renderSidebarShop() {
    ...
    if (currentShopView === 'menu') {
        ...
        html += `<button class="shop-btn" ${disAttr} style="width: 100%; padding: 25px; font-size: 18px; background: #111; color: #FFF; border: 2px solid #333; border-radius: 8px; font-weight: 900; ${disStyle} transition: 0.3s;" onmouseover="this.style.borderColor='#00FFFF'" onmouseout="this.style.borderColor='#333'" onclick="window.location.href='snake_intro.html';">🐍 SNAKE AND THE LADDER</button>`;
