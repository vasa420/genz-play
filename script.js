...
function renderSidebarShop() {
    ...
    if (currentShopView === 'menu') {
        ...
        html += `<button class="shop-btn" ${disAttr} style="width: 100%; padding: 25px; font-size: 18px; background: #111; color: #FFF; border: 2px solid #333; border-radius: 8px; font-weight: 900; ${disStyle} transition: 0.3s;" onmouseover="this.style.borderColor='#00FFFF'" onmouseout="this.style.borderColor='#333'" onclick="window.customAlert('Snake and the Ladder coming soon!', 'MORE GAMES');">🐍 SNAKE AND THE LADDER</button>`;
        ...
        html += `<button class="shop-btn" ${disAttr} style="width: 100%; padding: 25px; font-size: 18px; background: #111; color: #FFF; border: 2px solid #333; border-radius: 8px; font-weight: 900; ${disStyle} transition: 0.3s;" onmouseover="this.style.borderColor='#ADFF2F'" onmouseout="this.style.borderColor='#333'" onclick="window.customAlert('Hand Cricket coming soon!', 'MORE GAMES');">🏏 HAND CRICKET</button>`;
        html += `</div>`;
    }
