...
function renderSidebarShop() {
    ...
    if (currentShopView === 'menu') {
        ...
        html += `<button class="shop-btn" ${disAttr} style="width: 100%; padding: 25px; font-size: 18px; background: #111; color: #ff9f0a; border: 2px solid #333; border-radius: 8px; font-weight: 900; ${disStyle} transition: 0.3s;" onmouseover="this.style.borderColor='#ff9f0a'; this.style.boxShadow='0 0 15px rgba(255, 159, 10, 0.3)';" onmouseout="this.style.borderColor='#333'; this.style.boxShadow='none';" onclick="window.location.href='darkwood_escape.html';">🌲 DARKWOOD ESCAPE</button>`;
        html += `</div>`;
    }
...
window.launchGame = function(game) {
    ...
    } else if (game === 'darkwood') {
        window.location.href = 'darkwood_escape.html';
    }
};
